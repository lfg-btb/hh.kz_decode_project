...
const specializationTypesData = data.map(item =>{
    return {
        name: item["name"]
    }
})
...
module.exports = {
    up: async (queryInterface, Sequelize) => {
      ...
      // Вставка данных в таблицу "SpecializationTypes"
      await queryInterface.bulkInsert('SpecializationTypes', specializationTypesData, {});
